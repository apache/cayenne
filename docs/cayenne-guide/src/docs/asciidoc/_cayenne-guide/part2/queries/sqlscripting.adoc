...
----
include::{java-examples}/SQLScriptingTest.java[tags=variable]
----
...
[source,java,indent=0]
----
include::{java-examples}/SQLScriptingTest.java[tags=bindObjectEqual]
----
...
[source,java,indent=0]
----
include::{java-examples}/SQLScriptingTest.java[tags=bindObjectNotEqual]
----
