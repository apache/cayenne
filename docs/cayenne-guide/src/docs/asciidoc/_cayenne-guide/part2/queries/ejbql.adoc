...
NOTE: Since 5.0 selecting queries can be written as Strings with <<ql,ObjectSelect.parse(..)>>, that is the recommended
replacement for selecting `EJBQLQuery`. As soon as all of the `EJBQLQuery` capabilities become available
in `ObjectSelect`, we are planning to deprecate `EJBQLQuery`.
...
----
include::{java-examples}/EJBQLQueryTest.java[tags=create]
----
...
[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=select]
----

[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=delete]
----

[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=update]
----
...
[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=objectsAndScalars]
----

A result can also be a list of scalars:
[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=scalars]
----
...
[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=inPositional]
----
...
[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=inCollection]
----
...
[source,java,indent=0]
----
include::{java-examples}/EJBQLQueryTest.java[tags=inCollectionInParentheses]
----
...
- Null handling: ObjectSelect would translate the expressions matching NULL values to the corresponding "X IS NULL" or
...
- Expression Parameters: ObjectSelect uses "$" to denote named parameters (e.g. "$myParam"), while EJBQL uses ":"
