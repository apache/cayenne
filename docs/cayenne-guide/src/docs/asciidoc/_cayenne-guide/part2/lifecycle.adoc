...
.^|PostLoad
a|
- After an object is fetched inside ObjectContext.select().
...
----
include::{java-examples}/lifecycle/Order.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/modeler/_Order.java[tags=content]

include::{java-examples}/lifecycle/modeler/Order.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/OrderListener.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/Listener1.java[tags=content]

include::{java-examples}/lifecycle/Listener2.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/LifecycleTest.java[tags=listeners]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/AnnotationExamples.java[tags=multipleEntities]
----

[source,java,indent=0]
----
include::{java-examples}/lifecycle/AnnotationExamples.java[tags=multipleAnnotations]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/Tag.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/Listener3.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/MyEntity1.java[tags=content]

include::{java-examples}/lifecycle/MyEntity2.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/lifecycle/CommittedObjectCounter.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/LifecycleTest.java[tags=syncFilter]
----
