...
----
include::{java-examples}/TuningTest.java[tags=prefetch]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=prefetchPath]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=prefetchMultiple]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=sqlSelectPrefetch]
----
...
[source, SQL]
----
SELECT a FROM Artist a LEFT JOIN FETCH a.paintingArray
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=dataRows]
----

[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=sqlDataRows]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=objectFromDataRow]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=iterator]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=iterate]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=batchIterator]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=pagination]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=dataRowsPagination]
----
...
[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=localCache]
----
...
So in addition to those policies, the app can invalidate individual cache groups explicitly via `QueryCache`:

[source,java,indent=0]
----
include::{java-examples}/TuningTest.java[tags=removeGroup]
----
...
[source,java,indent=0]
----
include::{java-examples}/tuning/MyModule.java[tags=content]
----
