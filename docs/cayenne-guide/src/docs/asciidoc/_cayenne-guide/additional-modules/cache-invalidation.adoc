...
----
include::{java-examples}/cacheinvalidation/MyEntity.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/cacheinvalidation/CustomInvalidationHandler.java[tags=content]
----
...
[source,java,indent=0]
----
include::{java-examples}/CacheInvalidationTest.java[tags=customHandler]
----
