...
----
include::{java-examples}/JCacheExamples.java[tags=providerConfig]
----
...
[source,java,indent=0]
----
include::{java-examples}/JCacheExamples.java[tags=cacheManager]
----
...
[source,java,indent=0]
----
include::{java-examples}/JCacheExamples.java[tags=ehcacheConfig]
----
