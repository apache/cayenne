...
----
include::{java-examples}/CryptoExamples.java[tags=columnMapper]
----
...
[source,java,indent=0]
----
include::{java-examples}/CryptoExamples.java[tags=keyStore]
----
...
[source,java,indent=0]
----
include::{java-examples}/CryptoExamples.java[tags=compressAndHMAC]
----
...
[source,java,indent=0]
----
include::{java-examples}/CryptoExamples.java[tags=bytesConverter]
----
