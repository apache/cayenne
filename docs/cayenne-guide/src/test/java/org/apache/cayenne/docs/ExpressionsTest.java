...
public class ExpressionsTest extends BaseTest {
    ...
    private Artist dali() {
        return ObjectSelect.query(Artist.class).where(Artist.ARTIST_NAME.eq("Dali")).selectOne(context);
    }
    ...
    public void objectParam() {
        ...
        Expression qualifier = ExpressionFactory.exp("toArtist = $artist", dali);
        // end::objectParam[]
    ...
    public void properties() {
        // tag::properties[]
        // Artist.ARTIST_NAME is generated by Cayenne and has a type of StringProperty<String>
        Expression e1 = Artist.ARTIST_NAME.eq("Pablo");

        // Chaining multiple properties into a path.
        // Painting.TO_ARTIST is generated by Cayenne and has a type of EntityProperty<Artist>
        Expression e2 = Painting.TO_ARTIST.dot(Artist.ARTIST_NAME).eq("Pablo");
        // end::properties[]

        assertEquals(ExpressionFactory.exp("artistName = 'Pablo'"), e1);
        assertEquals(ExpressionFactory.exp("toArtist.artistName = 'Pablo'"), e2);
    }
    ...
    public void match() {
        ...
        // tag::match[]
        Expression e = Artist.ARTIST_NAME.in("Dali", "Monet");
        Artist artist = dali();
        if (e.match(artist)) {
    ...
    public void evaluate() {
        ...
        // tag::evaluate[]
        String name = (String) Artist.ARTIST_NAME.getExpression().evaluate(artist);
        // end::evaluate[]
