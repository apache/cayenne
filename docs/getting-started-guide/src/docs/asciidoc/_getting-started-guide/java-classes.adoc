...
section. CayenneModeler can be used to also generate the database schema, but since later in the
tutorial we'll tell Cayenne to create the schema on startup, we'll skip this step. Still be aware
that you can do it if you need to via "Tools > Create Database Schema".
