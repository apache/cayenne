...
[main] INFO cayenne-sql - generated PK ID:2
[main] INFO cayenne-sql - INSERT INTO cayenne_demo.artist (DATE_OF_BIRTH, NAME) VALUES (?, ?) [bind:[DATE_OF_BIRTH:NULL,name:'Picasso']] [updated:1]
----