...
==== Launching CayenneModeler

CayenneModeler can be helpful in case you want to make some customizations to your model, though its usage is optional.

Launch the Modeler from your downloaded Cayenne distribution and pass the project file as an argument, for example:

----
$ java -jar CayenneModeler.jar src/main/resources/cayenne-project.xml
----

On macOS:

----
$ open CayenneModeler.app --args src/main/resources/cayenne-project.xml
----

Alternatively, launch the Modeler with no arguments and open the project via the *File > Open Project...* menu.