...
public class _Department extends org.objectstyle.cayenne.CayenneDataObject {
    ...
    public void addToEmployees(org.objectstyle.cayenne.testdo.inherit.Employee obj) {
        addToManyTarget("employees", obj, true);
    }
    public void removeFromEmployees(org.objectstyle.cayenne.testdo.inherit.Employee obj) {
    ...
    public void addToToManager(org.objectstyle.cayenne.testdo.inherit.Manager obj) {
        addToManyTarget("toManager", obj, true);
    }
    public void removeFromToManager(org.objectstyle.cayenne.testdo.inherit.Manager obj) {
