...
/** Class _ToManyFkRoot was generated by Cayenne.
  ...
  */
public class _ToManyFkRoot extends org.objectstyle.cayenne.CayenneDataObject {
    ...
    public void addToDeps(org.objectstyle.cayenne.testdo.relationship.ToManyFkDep obj) {
        addToManyTarget("deps", obj, true);
    }
    public void removeFromDeps(org.objectstyle.cayenne.testdo.relationship.ToManyFkDep obj) {
