...
public interface DataChannel {
     ...
     * @param iteratedResult if true, the result is returned as a {@link ResultIterator} item, and the caller is
     *                       responsible for closing it. If false, the result is fully read into a list.
