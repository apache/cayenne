...
/**
 * A Connection wrapper that interacts with the UnmanagedPoolingDataSource, allowing to recycle connections and track
 * failures.
 *
 * @since 4.0
 */
public class PoolAwareConnection implements Connection {
    ...
    private final UnmanagedPoolingDataSource parent;
