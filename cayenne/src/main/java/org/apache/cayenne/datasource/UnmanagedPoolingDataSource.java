 ...
 * @since 4.0
 */
public class UnmanagedPoolingDataSource implements DataSource, AutoCloseable {
    ...
    private final Map<PoolAwareConnection, Object> pool;
    ...
    private PoolAwareConnection uncheckBlocking() {
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        return UnmanagedPoolingDataSource.class.equals(iface) || nonPoolingDataSource.isWrapperFor(iface);
    }
