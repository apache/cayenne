 ...
 */
public abstract class _ToManyRoot2 extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<ToManyRoot2> SELF = PropertyFactory.createSelf(ToManyRoot2.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("ID", "ToManyRoot2", Integer.class);
