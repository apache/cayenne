 ...
 */
public abstract class _EnumEntity3 extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<EnumEntity3> SELF = PropertyFactory.createSelf(EnumEntity3.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("ID", "EnumEntity3", Integer.class);
