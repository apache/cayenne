 ...
 */
public abstract class _BooleanTestEntity extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<BooleanTestEntity> SELF = PropertyFactory.createSelf(BooleanTestEntity.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("ID", "BooleanTestEntity", Integer.class);
