 ...
 */
public abstract class _Lazyblob extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Lazyblob> SELF = PropertyFactory.createSelf(Lazyblob.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("ID", "Lazyblob", Integer.class);
