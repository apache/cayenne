 ...
 */
public abstract class _Dependent extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Dependent> SELF = PropertyFactory.createSelf(Dependent.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "Dependent", Integer.class);
