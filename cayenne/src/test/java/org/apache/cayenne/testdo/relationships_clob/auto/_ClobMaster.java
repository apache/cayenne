 ...
 */
public abstract class _ClobMaster extends PersistentObject {

    public static final SelfProperty<ClobMaster> SELF = PropertyFactory.createSelf(ClobMaster.class);

    public static final NumericIdProperty<Integer> CLOB_MASTER_ID_PK_PROPERTY = PropertyFactory.createNumericId("CLOB_MASTER_ID", "ClobMaster", Integer.class);
