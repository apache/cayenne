...
public class DataContextOuterJoinsIT {
    ...
    public void cleanUpDB() throws Exception {
        ...
        paintingHelper = env
                .table("PAINTING", "PAINTING_ID", "ARTIST_ID", "PAINTING_TITLE")
                .setColumnTypes(Types.INTEGER, Types.BIGINT, Types.VARCHAR);

        artgroupHelper = env.table("ARTGROUP", "GROUP_ID", "NAME");
        artistGroupHelper = env.table("ARTIST_GROUP", "GROUP_ID", "ARTIST_ID");
    }
