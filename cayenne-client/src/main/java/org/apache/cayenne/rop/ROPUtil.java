...
public class ROPUtil {
    ...
    public static String getLogConnect(String url, String username, String password, String sharedSessionName) {
    ...
    public static String getLogDisconnect(String url, String username, String password) {
