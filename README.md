...
[![Maven Central](https://img.shields.io/maven-central/v/org.apache.cayenne/cayenne-server/4.1.RC1.svg)](https://cayenne.apache.org/download/)
...
buildscript {
    ...
    dependencies {
        classpath group: 'org.apache.cayenne.plugins', name: 'cayenne-gradle-plugin', version: '4.1.RC1'
...
```groovy
compile group: 'org.apache.cayenne', name: 'cayenne-server', version: '4.1.RC1'
