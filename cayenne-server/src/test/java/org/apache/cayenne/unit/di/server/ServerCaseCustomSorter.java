...
import org.apache.cayenne.unit.util.CustomSorterServerRuntimeProvider;
import org.junit.Before;

public class ServerCaseCustomSorter extends DICase {
    ...
    static {
        ...
        injector = DIBootstrap.createInjector(
                ...
                binder -> binder.bind(ServerRuntime.class)
                        .toProvider(CustomSorterServerRuntimeProvider.class)
                        .in(testScope));
