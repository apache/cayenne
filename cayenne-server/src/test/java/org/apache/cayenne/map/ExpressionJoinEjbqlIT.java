...
public class ExpressionJoinEjbqlIT extends ServerCase {
    ...
    public void testQualifier() {
        Expression e = ArtistJoinExp.PAINTINGS.dot(PaintingJoinExp.PAINTING_JOIN_ID).eq(1);
        EJBQLQuery query = new EJBQLQuery("select a FROM ArtistJoinExp a where " + e.toEJBQL("a"));
