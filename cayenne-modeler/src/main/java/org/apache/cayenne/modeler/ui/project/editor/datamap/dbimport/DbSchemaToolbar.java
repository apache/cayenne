...
class DbSchemaToolbar extends JToolBar {
    ...
    DbSchemaToolbar(DbImportActions actions) {
        JButton configureButton = actions.getGetDbConnectionAction().buildButton(0);
        ...
        AppAction.CayenneToolbarButton reverseEngineeringButton =
                (AppAction.CayenneToolbarButton) actions.getReverseEngineeringAction().buildButton(0);
