...
public class RemoveObjAttributeUndoableEdit extends BaseRemovePropertyUndoableEdit {

    private final ObjAttribute[] attributes;

    public RemoveObjAttributeUndoableEdit(ProjectSession session, ObjEntity entity, ObjAttribute[] attributes) {
        super(session);
    ...
    public void redo() throws CannotRedoException {
        ...
        action.removeObjAttributes(objEntity, attributes);
        focusObjEntity();
    }
    ...
    public String getPresentationName() {
        return (attributes.length > 1) ? "Remove ObjAttributes" : "Remove ObjAttribute";
    }
}
