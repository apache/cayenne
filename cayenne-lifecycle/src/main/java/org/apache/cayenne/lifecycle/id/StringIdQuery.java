 ...
 * {@link ObjectContext#execute(Query)}. The returned result will contain a separate
 * {@link org.apache.cayenne.QueryResult.Select} of DataRows for each type in no particular order.
 * <p>
