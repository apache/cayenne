...
public class RemoveDbRelationshipUndoableEdit extends BaseRemovePropertyUndoableEdit {

    private final DbRelationship[] relationships;

    public RemoveDbRelationshipUndoableEdit(ProjectSession session, DbEntity dbEntity, DbRelationship[] relationships) {
        super(session);
