...
public class ErrorsController {
    ...
    public static void guiException(Throwable th) {
        ...
        new ErrorDialog(Application.getFrame(), "CayenneModeler Error", th, true, false).setVisible(true);
    }
    ...
    public static void guiWarning(Throwable th, String message) {
        ...
        new WarningDialog(Application.getFrame(), message, th, false, false).setDetailed(true);
    }
}
