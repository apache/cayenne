 ...
 *
 */
public class MainDataNodeEditorController extends ChildController<ProjectController> {
    ...
    protected DataNodeEditorController tabbedPaneController;
    ...
    public MainDataNodeEditorController(ProjectController parent, DataNodeEditorController tabController) {
        ...
        this.nodeChangeProcessor = () -> parent.fireDataNodeEvent(new DataNodeEvent(MainDataNodeEditorController.this, node));
    ...
    protected void initController() {
        ...
        TextBinder.bind(view.getDataNodeName(), v -> {
            ...
            DataNodeEvent e = new DataNodeEvent(MainDataNodeEditorController.this, node);
        ...
        TextBinder.bind(view.getCustomAdapter(), v -> {
            if (node == null) return;
            setAdapterName(v);
            parent.fireDataNodeEvent(new DataNodeEvent(MainDataNodeEditorController.this, node));
        });
