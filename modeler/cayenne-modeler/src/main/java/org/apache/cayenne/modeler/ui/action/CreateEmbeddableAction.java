...
public class CreateEmbeddableAction extends AppAction {
    ...
    public void performAction(ActionEvent e) {
        ...
        String baseName = NameBuilder.of(embeddable, dataMap).build();
        ...
        app.getUndoManager().addEdit(new CreateEmbeddableUndoableEdit(getProjectSession(), dataMap, embeddable));
    }
