...
class SQLSyntax implements TextSyntax {
    ...
    private static final String[] KEYWORDS2 = {"ABS", "ACOS", "ADD_MONTHS", "ASCII",
    ...
    private static final String[] TYPES = {"binary", "bit", "blob", "boolean",
    ...
    private static final String[] OPERATORS = {"ALL", "AND", "ANY", "BETWEEN", "BY",
