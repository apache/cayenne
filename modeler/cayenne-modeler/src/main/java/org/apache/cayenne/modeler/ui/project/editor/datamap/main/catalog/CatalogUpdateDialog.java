...
public class CatalogUpdateDialog extends DefaultsUpdateDialog {

    private static final String ALL_CONTROL = "Set/update catalog for all DbEntities";
    private static final String UNINIT_CONTROL = "Do not override existing non-empty catalog";

    public CatalogUpdateDialog(ProjectSession session, Window owner, DataMap dataMap) {
        super(session, owner, dataMap, "Update DbEntities Catalog", ALL_CONTROL, UNINIT_CONTROL);
    }
