...
public class RemoveObjRelationshipUndoableEdit extends BaseRemovePropertyUndoableEdit {

    private final ObjRelationship[] relationships;

    public RemoveObjRelationshipUndoableEdit(ProjectSession session, ObjEntity objEntity, ObjRelationship[] relationships) {
        super(session);
