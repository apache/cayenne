...
// TODO: suspect... The only place where we have this editor
class ObjAttributeTableCellEditor implements TableCellEditor {

    private final JTable table;
    protected Hashtable editors;
    protected TableCellEditor editor, defaultEditor;

    public ObjAttributeTableCellEditor(JTable table, JComboBox combo) {
        this.table = table;
