...
public class RemoveDbAttributeUndoableEdit extends BaseRemovePropertyUndoableEdit {

    private final DbAttribute[] attributes;

    public RemoveDbAttributeUndoableEdit(ProjectSession session, DbEntity entity, DbAttribute[] attributes) {
        super(session);
    ...
    public void redo() throws CannotRedoException {
        ...
        action.removeDbAttributes(dbEntity.getDataMap(), dbEntity, attributes);
        focusDBEntity();
    }
    ...
    public String getPresentationName() {
        return (attributes.length > 1) ? "Remove DbAttributes" : "Remove DbAttribute";
    }
}
