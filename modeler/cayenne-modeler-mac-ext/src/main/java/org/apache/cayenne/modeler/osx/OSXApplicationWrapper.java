 ...
 * @see #setQuitHandler(OSXQuitHandler) run action on "Quit App" menu item select
 *
...
public class OSXApplicationWrapper {
    ...
    public void setQuitHandler(final OSXQuitHandler quitHandler) {
        InvocationHandler handler = new InvocationHandler() {
            @Override
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                // args: 0 - event, 1 - quitResponse
                quitHandler.handle(new OSXQuitResponseWrapper(args[1]));
                return null;
            }
        };
    ...
    private void setHandler(Method setMethod, Class<?> handlerClass, final Runnable action) {
        InvocationHandler handler = new InvocationHandler() {
            @Override
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                action.run();
