...
public class CommitLogFilterIT extends AuditableServerCase {
    ...
    public void testPostCommit_Update() throws SQLException {
        ...
        ObjectChange c = changeMap.getValue().getChanges().get(new ObjectId("Auditable1", Auditable1.ID_PK_COLUMN, 1));
        assertNotNull(c);
    ...
    public void testPostCommit_Delete() throws SQLException {
        ...
        ObjectChange masterChange = changeMap.getValue().getChanges().get(new ObjectId("Auditable1", Auditable1.ID_PK_COLUMN, 1));
        ...
        ObjectChange childChange = changeMap.getValue().getChanges().get(new ObjectId("AuditableChild1", AuditableChild1.ID_PK_COLUMN, 2));
    ...
    public void testPostCommit_Delete_ToOneNullify() throws SQLException {
        ...
        ObjectChange change = changeMap.getValue().getChanges().get(new ObjectId("AuditableChild1", AuditableChild1.ID_PK_COLUMN, 2));
    ...
    public void testPostCommit_UpdateToMany() throws SQLException {
        ...
        ObjectChange a1c = changeMap.getValue().getChanges().get(new ObjectId("Auditable1", Auditable1.ID_PK_COLUMN, 1));
        assertNotNull(a1c);
