...
public class EqualsBuilder {
     ...
     * fields. This means that it will throw a security exception if run under a security
     * manager, if the permissions are not set up correctly. It is also not as efficient
     * as testing explicitly.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * If the TestTransients parameter is set to <code>true</code>, transient members
     * will be tested, otherwise they are ignored, as they are likely derived fields, and
