...
/** Class _MtTable1 was generated by Cayenne.
  ...
  */
public abstract class _MtTable1 extends org.apache.cayenne.CayenneDataObject {
    ...
    public void addToTable2Array(org.apache.cayenne.testdo.mt.MtTable2 obj) {
        addToManyTarget("table2Array", obj, true);
    }
    public void removeFromTable2Array(org.apache.cayenne.testdo.mt.MtTable2 obj) {
        removeToManyTarget("table2Array", obj, true);
    }
    public java.util.List getTable2Array() {
        return (java.util.List)readProperty("table2Array");
    }
