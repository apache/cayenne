...
public abstract class _CompoundPaintingLongNames extends CayenneDataObject {
    ...
    public static final String TO_SAME_ARIST_PAINTINGS_FLATTENED_PROPERTY = "toSameAristPaintingsFlattened";
    ...
    public List<CompoundPainting> getToSameAristPaintingsFlattened() {
        return (List<CompoundPainting>)readProperty("toSameAristPaintingsFlattened");
    }
