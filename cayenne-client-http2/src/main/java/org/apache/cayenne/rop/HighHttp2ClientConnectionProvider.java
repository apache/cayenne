 ...
 */
public class HighHttp2ClientConnectionProvider implements Provider<ClientConnection> {
    ...
    protected HighHttp2ROPConnector createHttp2ROPConnector() {
        ...
        HighHttp2ROPConnector ropConnector = new HighHttp2ROPConnector(url, username, password, realm, false);
